...
class Model(nn.Module):
    def __init__(self, config, *inputs, **kwargs):
        ...
        # Batch size for encoder inference over context pairs (tunable for GPU mem)
        self.encode_batch_size = kwargs.get('encode_batch_size', 2000)
    ...
    def encoder_inference(self, mapping):
        ...
        bs = self.encode_batch_size  # depends on gpu mem
