...
from dataloaders import ESConv, DailyDialogue, ESConvPreProcessed, AnnoMIPreProcessed, ESConvTelugu, ESConvTeluguPreProcessed
...
from modules.roberta.xlmr_cls_baseline import XLMRDialogueCLSBaseline
...
DATASETS = {
    ...
    "esconv-telugu": ESConvTelugu,
    "esconv-telugu-preprocessed": ESConvTeluguPreProcessed,
}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lightmode', type=int, default=0)
    parser.add_argument('--parse_bs', type=int, default=4096)
    parser.add_argument('--parse_ctx_len', type=int, default=48)
    ...
    if args.model == 'xlmr-hg-telugu':
        model = MODELS[args.model]["model"](args, lightmode=bool(args.lightmode))
    else:
